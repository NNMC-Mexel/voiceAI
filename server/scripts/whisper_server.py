...
INITIAL_PROMPT  = os.environ.get(
    ...
    "Медицинский протокол. Жалобы. Анамнез заболевания. Анамнез жизни. Объективный статус. "
    "Неврологический статус. Менингеальных знаков нет. Парезов нет. "
    "АД – 150/90 мм рт.ст. Максимальные цифры АД до 180/110 мм рт.ст. "
    "ЧСС – 76 уд/мин. SpO₂ 96%. СОЭ 12 мм/ч. ИМТ 31,8 кг/м². "
    "ЭКГ от 28.04.2026г. ЭхоКГ от 12.04.2026г. ФВ 58%. Тредмил-тест. Холтер ЭКГ. УЗДГ. "
    "ОАК: гемоглобин 146 г/л, эритроциты 4,9 *10¹²/л, лейкоциты 6,7 *10⁹/л, СОЭ 12 мм/ч. "
    "биохимия: креатинин 98 мкмоль/л, СКФ 72 мл/мин, АЛТ 31 МЕ/л, АСТ 27 МЕ/л, "
    "общий холестерин 6,8 ммоль/л, ЛПНП 4,2 ммоль/л, ЛПВП 0,92 ммоль/л, "
    "триглицериды 2,4 ммоль/л, С-реактивный белок 3,2 мг/л. "
    "HbA1c 7,8%. Глюкоза 8,9 ммоль/л. Альбумин-креатининовое соотношение 42 мг/г. "
    "ИБС, стабильная стенокардия, артериальная гипертензия, сахарный диабет 2 типа, "
    "дислипидемия, ожирение, полинейропатия. "
    "валсартан, амлодипин, метформин, аторвастатин, розувастатин, эмпаглифлозин, "
    "ацетилсалициловая кислота, нитроглицерин, метопролол, периндоприл.",
)
