...
export const PARAM_VOICE_ALIASES: Record<string, Array<{ pattern: RegExp; paramName: string }>> = {
  oak: [
    ...
    { pattern: /нейтрофил/iu, paramName: 'нейтрофилы' },
    { pattern: /нейтр\b/iu, paramName: 'нейтрофилы' },
    { pattern: /эозинофил/iu, paramName: 'эозинофилы' },
    { pattern: /эоз\b/iu, paramName: 'эозинофилы' },
    { pattern: /базофил/iu, paramName: 'базофилы' },
    { pattern: /базоф\b/iu, paramName: 'базофилы' },
    { pattern: /моноцит/iu, paramName: 'моноциты' },
    { pattern: /моноц\b/iu, paramName: 'моноциты' },
    { pattern: /лимфоцит/iu, paramName: 'лимфоциты' },
    { pattern: /лц\b/iu, paramName: 'лимфоциты' },
  ...
  biochem: [
    ...
    { pattern: /ЛЖСС/iu, paramName: 'ЛЖСС' },
    { pattern: /латентн\S+\s+железосвязывающ/iu, paramName: 'ЛЖСС' },
    { pattern: /ОЖСС/iu, paramName: 'ОЖСС' },
    { pattern: /общ\S+\s+железосвязывающ/iu, paramName: 'ОЖСС' },
    { pattern: /трансферрин/iu, paramName: 'трансферрин' },
    { pattern: /TSat/iu, paramName: 'TSat' },
    { pattern: /процент\s+насыщения\s+трансферрина/iu, paramName: 'TSat' },
    { pattern: /насыщени\S+\s+трансферрина/iu, paramName: 'TSat' },
    { pattern: /витамин\s+В12/iu, paramName: 'витамин В12' },
    { pattern: /витамин\s+B12/iu, paramName: 'витамин В12' },
    { pattern: /витамин\s+[ДD]/iu, paramName: 'витамин D' },
    { pattern: /25-ОН/iu, paramName: 'витамин D' },
    { pattern: /фолиев\S+\s+кислот/iu, paramName: 'фолиевая кислота' },
    { pattern: /HbA1c/iu, paramName: 'HbA1c' },
    { pattern: /гликированный\s+гемоглобин/iu, paramName: 'HbA1c' },
    { pattern: /С-реактивн\S+\s+белок/iu, paramName: 'С-реактивный белок' },
    { pattern: /СРБ/u, paramName: 'С-реактивный белок' },
    { pattern: /срб/iu, paramName: 'С-реактивный белок' },
    { pattern: /мочевин[аы]/iu, paramName: 'мочевина' },
    { pattern: /магний/iu, paramName: 'магний' },
    { pattern: /ГГТП/iu, paramName: 'ГГТП' },
    { pattern: /гамма-?глутамил/iu, paramName: 'ГГТП' },
    { pattern: /ЛДГ/u, paramName: 'ЛДГ' },
    { pattern: /лдг/iu, paramName: 'ЛДГ' },
    { pattern: /лактат\S+\s+дегидрогеназ/iu, paramName: 'ЛДГ' },
    { pattern: /ЩФ/u, paramName: 'ЩФ' },
    { pattern: /щф/iu, paramName: 'ЩФ' },
    { pattern: /щелочн\S+\s+фосфатаз/iu, paramName: 'ЩФ' },
    { pattern: /фибриноген/iu, paramName: 'фибриноген' },
  ],
  oam: [
