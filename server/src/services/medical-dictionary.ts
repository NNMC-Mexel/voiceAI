...
const PHONETIC_CORRECTIONS: ReplacementRule[] = [
  ...
  // "аортасклероз/аортосклероз" → "атеросклероз аорты" (склеенные слова / Whisper)
  regexRule(/аорт[ао]склероз/giu, 'атеросклероз аорты'),
  ...
  // "делетация" → "дилатация" (Whisper ошибка)
  regexRule(/делетаци/giu, 'дилатаци'),
